...
<!-- Screenshot placeholder: screenshot-main-light.png (main interface in light mode, showing space list, conversation area, and toolbar) -->
...
- Learn about [Spaces in full detail](/en/features/spaces)
- Enable the [AI Browser](/en/features/ai-browser) and let AI operate web pages automatically
- Configure [Remote Access](/en/features/remote-access) to control Halo from anywhere
